            ...
            {data.map((zone) => (
              ...
              >
                <div className="flex justify-between items-start mb-3">
                  ...
                  <span
                    className={`px-2 py-0.5 rounded-full text-[0.625rem] font-semibold border ${zone.aqi > 100 ? "text-red-500 bg-red-500/10 border-red-500/20" : "text-green-500 bg-green-500/10 border-green-500/20"}`}
                  >
